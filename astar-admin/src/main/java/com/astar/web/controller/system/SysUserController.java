...
import com.astar.common.core.domain.entity.SysDept;
...
import com.astar.system.service.ISysDeptService;
import com.astar.system.service.ISysPostService;
import com.astar.system.service.ISysRoleService;
...
public class SysUserController extends BaseController
{
    ...
    @Autowired
    private ITbGradeClassService tbGradeClassService;
    ...
    public TableDataInfo list(SysUser user)
    {
        ...
        for (SysUser sysUser : list) {
            if (StringUtils.isNotBlank(sysUser.getGradeClassId())) {
                GradeClass gradeClass = tbGradeClassService.getById(sysUser.getGradeClassId());
                gradeClass = Optional.ofNullable(gradeClass).orElse(new GradeClass());
                sysUser.setGradeClassName(gradeClass.getGradeClassName());
            }
        }
